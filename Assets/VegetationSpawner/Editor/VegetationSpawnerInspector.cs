...
namespace sc.terrain.vegetationspawner
{
    ...
    public class VegetationSpawnerInspector : Editor
    {
        ...
        {
            EditorGUILayout.LabelField("Version " + VegetationSpawner.Version, EditorStyles.centeredGreyMiniLabel);
            ...
            EditorGUILayout.LabelField("- SkyBreaker Softworks 2023 -", EditorStyles.centeredGreyMiniLabel);
        }

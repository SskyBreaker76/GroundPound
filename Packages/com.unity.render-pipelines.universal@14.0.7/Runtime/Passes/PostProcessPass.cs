...
namespace UnityEngine.Rendering.Universal
{
    ...
    public class PostProcessPass : ScriptableRenderPass
    {
        ...
        public static MaterialLibrary m_Materials;
            ...
            using (new ProfilingScope(cmd, ProfilingSampler.Get(URPProfileId.UberPostProcess)))
            {
                ...
                if (bloomActive)
                {
                    using (new ProfilingScope(cmd, ProfilingSampler.Get(URPProfileId.Bloom)))
                    {
                        ...
                        m_Materials.bloomComposite.SetFloat("_LuminAmount", m_Bloom.dotsLuminAmount.value);
                        m_Materials.bloomComposite.SetFloat("_LuminOffset", m_Bloom.dotsLuminAdd.value);
                        m_Materials.bloomComposite.SetFloat("_AO_Cutoff", m_Bloom.ambientOcclusionCutoff.value);
                        m_Materials.bloomComposite.SetFloat("_Cutoff", m_Bloom.dotsCutoff.value);
                        m_Materials.bloomComposite.SetFloat("_Density", m_Bloom.dotsDensity.value);
                        m_Materials.bloomComposite.SetVector("_Direction", m_Bloom.scrollDirection.value);
                        
                        Blitter.BlitCameraTexture(cmd, GetSource(), GetSource(), m_Materials.bloomComposite, 0);
                    }
                }
...
#region Panini Projection
        ...
        void SetupBloom(CommandBuffer cmd, RTHandle source, Material uberMaterial)
        {
            ...
            RenderingUtils.ReAllocateIfNeeded(ref FinalRender, GetCompatibleDescriptor(m_Descriptor.width, m_Descriptor.height, m_Descriptor.graphicsFormat), FilterMode.Bilinear, TextureWrapMode.Clamp, name: "_Bloom_FinalRender");
            ...
            m_Materials.bloomComposite.SetTexture("_BloomTex", m_BloomMipUp[0]);
            m_Materials.bloomComposite.SetFloat("_BloomIntensity", m_Bloom.dotsIntensity.value);
            m_Materials.bloomComposite.SetFloat("_BloomAdd", m_Bloom.dotsAdd.value);

            Blitter.BlitCameraTexture(cmd, source, FinalRender, RenderBufferLoadAction.DontCare, RenderBufferStoreAction.Store, m_Materials.bloomComposite, 0);
            cmd.SetGlobalTexture(ShaderConstants._Bloom_Texture, FinalRender);
...
#region Internal utilities
        ...
        public class MaterialLibrary
        {
            ...
            public readonly Material bloomComposite;
            ...
            public MaterialLibrary(PostProcessData data)
            {
                ...
                bloomComposite = Load(data.shaders.bloomComposite);

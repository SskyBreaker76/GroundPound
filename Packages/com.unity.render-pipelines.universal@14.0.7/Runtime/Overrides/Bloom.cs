...
namespace UnityEngine.Rendering.Universal
{
    ...
    public sealed partial class Bloom : VolumeComponent, IPostProcessComponent
    {
        ...
        [Header("Ben Day Effect")]
        public FloatParameter dotsAdd = new FloatParameter(1, true);
        public MinFloatParameter dotsIntensity = new MinFloatParameter(1f, 0f, true);
        ...
        public FloatParameter ambientOcclusionCutoff = new FloatParameter(0f, true);
        public FloatParameter dotsLuminAdd = new FloatParameter(0f, true);
        public FloatParameter dotsLuminAmount = new FloatParameter(3f / 3f, true);
